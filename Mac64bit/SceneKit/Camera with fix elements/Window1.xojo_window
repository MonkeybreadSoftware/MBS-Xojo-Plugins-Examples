...
#tag WindowCode
	#tag Method, Flags = &h0
		Sub FixToCamera()
		  ...
		  sphere1Geometry.firstMaterial.diffuse.contents = NSColorMBS.greenColor
		  sphere1Geometry.firstMaterial.emission.intensity = 2000
		  sphere1.Position = New SCNVector3MBS(3, 0, -10)
		  //Child of the camera
		  CameraNode.addChildNode(sphere1)
		  
		  //sphere red
		  Dim sphere2Geometry As New SCNSphereMBS(1)
		  Dim sphere2 As New SCNNodeMBS(sphere2Geometry)
		  sphere2Geometry.firstMaterial.diffuse.contents = NSColorMBS.redColor
		  sphere2.Position = New SCNVector3MBS(-3, 0, -10)
		  //Child of the camera 
		  CameraNode.addChildNode(sphere2)
...
#tag Events Timer1
	#tag Event
		Sub Action()
		  //Set the camera view to the position of the point of view
		  CameraNode.Position = MyView.pointOfView.Position
		  CameraNode.orientation = MyView.pointOfView.orientation
		  CameraNode.EulerAngles = MyView.pointOfView.EulerAngles
