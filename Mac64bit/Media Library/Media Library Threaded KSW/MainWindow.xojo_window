...
Begin Window MainWindow
   ...
   Begin Label Label1
      ...
      TabPanelIndex   =   0
      TabStop         =   True
      Text            =   "App needs to be code signed to see playlists."
      TextAlign       =   0
      TextColor       =   &c00000000
      TextFont        =   "System"
      TextSize        =   0.0
...
#tag WindowCode
	...
	#tag Property, Flags = &h0
		xLoadMediaLibrary As ThreadMediaLibrary
	#tag EndProperty


#tag EndWindowCode

#tag Events tmrCheckThread
	#tag Event
		Sub Action()
