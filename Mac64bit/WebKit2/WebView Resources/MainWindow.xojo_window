...
Begin Window MainWindow
   ...
   Begin Listbox List
      ...
      Index           =   -2147483648
      InitialParent   =   ""
      InitialValue    =   "URL	Main Frame	Mime Type	suggested filename"
      Italic          =   False
      Left            =   20
      LockBottom      =   True
      LockedInPosition=   False
...
#tag Events browser
	...
	#tag Event
		Function decidePolicyForNavigationAction(URL as String, NavigationType as String, modifierFlags as Integer, buttonNumber as Integer, newWindow as boolean, frameName as string, request as NSURLRequestMBS) As boolean
		  ...
		  Return False // allow. Pass true to cancel.
		  
		  
		End Function
	#tag EndEvent
	#tag Event
		Function decidePolicyForNavigationResponse(navigationResponse as WKNavigationResponseMBS) As boolean
		  ...
		  Return False // allow. Pass true to disallow.
