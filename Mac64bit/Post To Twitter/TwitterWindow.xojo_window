...
Begin Window TwitterWindow
   ...
   Begin PushButton RequestAccessButton
      ...
      ButtonStyle     =   0
      Cancel          =   False
      Caption         =   "Request Access to Twitter Accounts"
      Default         =   False
      Enabled         =   True
      Height          =   20
      HelpTag         =   ""
...
#tag WindowCode
	...
	#tag Property, Flags = &h0
		accountStore As myACAccountStoreMBS
	#tag EndProperty

	#tag Property, Flags = &h0
		accountType As ACAccountTypeMBS
	#tag EndProperty
...
#tag Events RequestAccessButton
	#tag Event
		Sub Action()
		  ...
		  accountType = accountStore.accountTypeWithAccountTypeIdentifier(ACAccountTypeMBS.ACAccountTypeIdentifierTwitter)
		  
		  accountStore.requestAccessToAccountsWithType(accountType, nil)
	...
	#tag Event
		Sub Action()
		  ...
		  if Accounts.Ubound = -1 then
		    MsgBox "No twitter account?"
		    Return
		  end if
		  
		  dim twitterAccount as ACAccountMBS = Accounts(UBound(Accounts))
		  ...
		  dim postRequest as new mySLRequestMBS( SLRequestMBS.SLServiceTypeTwitter, SLRequestMBS.SLRequestMethodPOST, requestURL, dic)
