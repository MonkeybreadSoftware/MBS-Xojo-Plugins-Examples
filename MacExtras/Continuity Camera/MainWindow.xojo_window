...
Begin Window MainWindow
   ...
   Begin Canvas Canvas1
      ...
      Width           =   560
   End
   Begin PushButton ImportPicButton
      AutoDeactivate  =   True
      Bold            =   False
      ButtonStyle     =   0
      Cancel          =   False
      ...
      Width           =   200
   End
   Begin PushButton ImportDocButton
      AutoDeactivate  =   True
      Bold            =   False
      ButtonStyle     =   0
      Cancel          =   False
...
#tag WindowCode
	...
	#tag Property, Flags = &h0
		ContinuityCamera As ContinuityCameraMBS
	#tag EndProperty
