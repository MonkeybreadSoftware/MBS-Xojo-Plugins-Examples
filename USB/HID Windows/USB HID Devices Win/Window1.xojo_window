...
Begin Window Window1
   ...
   Begin ListBox ListBox1
      ...
      Index           =   -2147483648
      InitialParent   =   ""
      InitialValue    =   "ProductID	VendorID	Product	Manufacturer	Serial	Version"
      Italic          =   False
      Left            =   20
      LockBottom      =   True
   ...
   Begin Label StaticText1
      ...
      TabPanelIndex   =   0
      TabStop         =   True
      Text            =   "This example lists all USB devices with Read/Write enabled for normal applications. So no driver is using it. If you see your device here, the WinHIDMBS class could be used to talk to it."
      TextAlign       =   0
      TextColor       =   
      TextFont        =   "System"
      TextSize        =   0.0
