...
Begin Window Window1
   ...
   Begin ListBox ListBox1
      ...
      ColumnWidths    =   "10%,10%,30%,30%,10%,10%"
      DataField       =   ""
      DataSource      =   ""
      DefaultRowHeight=   -1
   ...
   Begin Label StaticText1
      ...
      TabPanelIndex   =   0
      TabStop         =   True
      Text            =   "This example lists all USB HID devices connected to this Mac. If you see your device here, the MacHIDMBS class could be used to talk to it."
      TextAlign       =   0
      TextColor       =   
      TextFont        =   "System"
      TextSize        =   0.0
