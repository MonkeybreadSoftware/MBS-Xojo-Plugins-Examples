...
Begin Window Window1
   ...
   Begin Listbox List
      ...
      Index           =   -2147483648
      InitialParent   =   ""
      InitialValue    =   "Name	InputDriverName	OutputDriverName	MaximumSpeed	RatedSpeed"
      Italic          =   False
      Left            =   20
      LockBottom      =   True
   ...
   Begin Label StaticText1
      ...
      TabPanelIndex   =   0
      TabStop         =   True
      Text            =   "If your USB device is listed here as serial device, you can use the REALbasic Serial class. If it is not listed, check the USB HID Devices sample whether it is listed there."
      TextAlign       =   0
      TextColor       =   
      TextFont        =   "System"
      TextSize        =   0.0
