	...
	#tag Event
		Sub Open()
		  ...
		  for each d as WinUSBDeviceMBS in devices
		    List.AddRow hex(d.VendorID)
		    List.Cell(List.LastIndex,1) = d.Vendor
		    List.Cell(List.LastIndex,2) = hex(d.ProductID)
		    List.Cell(List.LastIndex,3) = d.Product
		    List.Cell(List.LastIndex,4) = d.SerialNumber
