...
#tag WindowCode
	#tag Event
		Sub Open()
		  ...
		  draw.Line(100, 200, 200, 300)
		  draw.Draw
		  
		  dim pattern1() as Double = array(5.0, 5.0, 0.0)
		  draw.DashArray(pattern1)
		  draw.Line(100, 250, 200, 350)
		  draw.Draw
		  
		  dim pattern2() as Double = array(3.0, 5.0, 3.0, 3.0, 0.0)
		  draw.DashArray(pattern2)
		  draw.Line(100, 300, 200, 400)
		  draw.Draw
