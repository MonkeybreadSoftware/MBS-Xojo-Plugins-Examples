...
#tag WindowCode
	#tag Method, Flags = &h0
		Sub Draw(out as graphics)
		  dim g as new GMGeometryMBS(500,500)
		  dim c as new GMColorRGBMBS("white") // white
		  dim image as new GMImageMBS(g, c)
		  
		  dim red as new GMColorRGBMBS("red")
		  dim green as new GMColorRGBMBS("green")
		  
		  red.alpha = Slider1.Value/100.0
		  green.alpha = Slider1.Value/100.0
		  ...
		  out.DrawPicture image.copyPicture,0,0
