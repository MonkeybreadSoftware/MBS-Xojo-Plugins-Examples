...
Begin Window Window1
   ...
   Begin ListBox ListBox1
      ...
      Index           =   -2147483648
      InitialParent   =   ""
      InitialValue    =   "Name	Description	Read	Write	MultiFrame"
      Italic          =   False
      Left            =   -1
      LockBottom      =   True
...
#tag WindowCode
	#tag Event
		Sub Open()
		  dim list(-1) as GM16CoderInfoMBS = GM16CoderInfoMBS.CoderInfoList
		  
		  for each i as GM16CoderInfoMBS in list
