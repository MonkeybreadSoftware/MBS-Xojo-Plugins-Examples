...
#tag WindowCode
	#tag Event
		Sub Open()
		  ...
		  image.SetPicture p,50,50
		  
		  Backdrop=image.CopyPicture(0,0,600,600)
		  
		  image.write SpecialFolder.Desktop.Child("test.tif")
		  'image.write "test.jpg"
		  
		  // crop image
		  
		  image.crop(new GM16GeometryMBS(300,300,0,0))
		  
		  image.write SpecialFolder.Desktop.Child("test top left.tif")
