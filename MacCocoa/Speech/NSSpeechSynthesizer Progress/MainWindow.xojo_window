...
#tag WindowCode
	...
	#tag Event
		Sub Open()
		  s=new MyNSSpeechSynthesizerMBS
	...
	#tag Property, Flags = &h1
		Protected s As MyNSSpeechSynthesizerMBS
	#tag EndProperty
...
#tag Events StartButton
	#tag Event
		Sub Action()
		  if s.startSpeakingString(EditField1.text) then
