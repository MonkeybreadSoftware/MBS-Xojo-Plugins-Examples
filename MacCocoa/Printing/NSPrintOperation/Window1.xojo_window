...
Begin Window Window1
   ...
   Begin TextArea TextArea1
      ...
      Width           =   400
   End
   Begin PushButton PageSetupButton
      AutoDeactivate  =   True
      Bold            =   False
      ButtonStyle     =   0
      Cancel          =   False
      ...
      Width           =   148
   End
   Begin PushButton PrintDialogButton
      AutoDeactivate  =   True
      Bold            =   False
      ButtonStyle     =   0
      Cancel          =   False
...
#tag WindowCode
	#tag Event
		Sub Open()
		  if TargetCocoa then
		    PrintInfo = NSPrintInfoMBS.sharedPrintInfo
		  else
...
#tag Events TextArea1
	#tag Event
		Sub Open()
		  ...
		  me.TextSize = 14
		  me.AppendText "Hello World"
		  me.AppendText EndOfLine
		  me.AppendText EndOfLine
		  me.AppendText "Just a test."
		  me.AppendText EndOfLine
		  
		End Sub
	#tag EndEvent
#tag EndEvents
#tag Events PageSetupButton
	#tag Event
		Sub Action()
...
#tag Events PrintPDFButton
	#tag Event
		Sub Action()
		  ...
		  dim o as NSPrintOperationMBS = NSPrintOperationMBS.PDFOperationWithView(v, v.bounds, PrintInfo, f)
