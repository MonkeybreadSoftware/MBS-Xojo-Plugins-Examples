...
Begin Window MainWindow
   ...
   Visible         =   True
   Width           =   600
   Begin CheckBox CheckFindbar
      AutoDeactivate  =   True
      Bold            =   False
      Caption         =   "Find bar visible"
      DataField       =   ""
      DataSource      =   ""
      Enabled         =   True
      Height          =   20
...
#tag WindowCode
	#tag Method, Flags = &h0
		Sub ToggleFindbar(TheTextArea as TextArea)
		  // get MBS objects for the Xojo controls
		  Dim textView   As NSTextViewMBS   = TheTextArea.NSTextViewMBS
		  Dim scrollView As NSScrollViewMBS = TheTextArea.NSScrollViewMBS
	...
	#tag Property, Flags = &h0
		finder As NSTextFinderMBS
	#tag EndProperty


#tag EndWindowCode

#tag Events CheckFindbar
	#tag Event
		Sub Action()
		  ToggleFindbar TextArea1
