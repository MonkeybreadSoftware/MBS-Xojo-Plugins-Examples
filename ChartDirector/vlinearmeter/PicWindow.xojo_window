...
#tag WindowCode
	#tag Event
		Sub Open()
		  ...
		  dim m as new CDLinearMeterMBS(60, 265, CDBaseChartMBS.silverColor, 0, -2)
		  ...
		  call m.addPointer(value, &h000080)
		  
		  // Add a text box label at top-center (30, 5) using Arial Bold/8 pts/deep blue
		  // (000088), with a light blue (9999ff) background
		  call m.addText(30, 5, "Temp C", "arialbd.ttf", 8, &h000088, CDBaseChartMBS.kTopCenter).setBackground(&h9999ff)
		  ...
		  // 3D border.
		  call m.addText(30, 260, m.formatValue(value, "2"), "arial.ttf", 8, &hffffff,CDBaseChartMBS.kBottomCenter).setBackground(0, 0, -1)
