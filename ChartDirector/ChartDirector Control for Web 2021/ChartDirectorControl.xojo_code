...
Inherits WebImageViewer
	...
	#tag Method, Flags = &h21
		Private Sub DrawItemInfo(X As Integer, Y As Integer)
		  ...
		  // this should convert normally and handle resolution
		  'Self.Picture = B
		  
		  // work around
		  Dim temp As New Picture(Me.Width, Me.Height)
		  
		  LastWebPicture = temp
		  LastWebPicture.Data = B.ToData(Global.Picture.Formats.JPEG, Global.Picture.QualityHigh)
	...
	#tag Method, Flags = &h0
		Sub Redraw()
		  ...
		  Else
		    ...
		    // the plugin should set them, but looks like those properties are broken! Feedback 64625
		    LastPicture.HorizontalResolution = 144
		    LastPicture.VerticalResolution = 144
		    ...
		    LastWebPicture = temp
		    LastWebPicture.Data = LastPicture.ToData(Global.Picture.Formats.JPEG, Global.Picture.QualityHigh)
	...
	#tag Method, Flags = &h0
		Sub Resized()
		  If LastPicture = Nil Or Self.Width <> LastPicture.Width Or Self.Height <> LastPicture.Height Then
