...
#tag WindowCode
	#tag Event
		Sub Open()
		  ...
		  dim Q0Data(-1) as double = array(40, 45, 35.0)
		  dim Q1Data(-1) as double = array(55, 60, 50.0)
		  dim Q2Data(-1) as double = array(62, 70, 60.0)
		  dim Q3Data(-1) as double = array(70, 80, 65.0)
		  dim Q4Data(-1) as double = array(80, 90, 75.0)
		  
		  // The labels for the chart
		  dim labels(-1) as string
		  
		  labels.append "<*img="+CDXYChartMBS.GetPath(FindFile("robot1.png"))+"*><*br*>Bipedal Type"
		  labels.append "<*img="+CDXYChartMBS.GetPath(FindFile("robot2.png"))+"*><*br*>Wolf Type"
		  labels.append "<*img="+CDXYChartMBS.GetPath(FindFile("robot5.png"))+"*><*br*>Bird Type"
		  
		  // Create a XYChart object of size 540 x 320 pixels
		  dim c as new CDXYChartMBS(540, 320)
