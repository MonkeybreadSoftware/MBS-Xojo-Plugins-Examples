...
#tag WindowCode
	#tag Event
		Sub Open()
		  ...
		  'Synchrozine the color axis with itself. This has the effect of breaking the default synchronization with the z-axis.
		  Call c.colorAxis.syncAxis(c.colorAxis, 0, 0)
		  
		  dim colors() as integer
		  
		  // red colors
		  colors.Append &h110000
		  colors.Append &h220000
		  colors.Append &h330000
		  colors.Append &h440000
		  colors.Append &h550000
		  colors.Append &h660000
		  colors.Append &h770000
		  colors.Append &h880000
		  colors.Append &h990000
		  colors.Append &hAA0000
		  colors.Append &hbb0000
		  colors.Append &hcc0000
		  colors.Append &hdd0000
		  colors.Append &hee0000
		  colors.Append &hFF0000
		  
		  'Now can set the axis scale
		  Call c.colorAxis.setLinearScale(-0.6, 0.6, 0.1)
		  Call c.colorAxis.setColorGradient(false, colors)
