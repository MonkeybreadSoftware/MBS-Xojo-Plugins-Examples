...
#tag WindowCode
	#tag Event
		Sub Open()
		  ...
		  c.addScatterLayer(dataX0, dataY0, "Technology AAA", c.kGlassSphere2Shape, 15, &hff3333).setSymbolScale(dataZ0)
		  ...
		  c.addScatterLayer(dataX1, dataY1, "Technology BBB", c.kGlassSphere2Shape, 15, &h0000ff).setSymbolScale(dataZ1)
