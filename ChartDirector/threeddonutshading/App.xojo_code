...
Inherits Application
	#tag Event
		Sub Open()
		  ...
		  createChart(0, "threeddonutshading0")
		  createChart(1, "threeddonutshading1")
		  createChart(2, "threeddonutshading2")
		  createChart(3, "threeddonutshading3")
		  createChart(4, "threeddonutshading4")
		  createChart(5, "threeddonutshading5")
		  createChart(6, "threeddonutshading6")
		  createChart(7, "threeddonutshading7")
