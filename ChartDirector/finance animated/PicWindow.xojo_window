...
#tag WindowCode
	...
	#tag Method, Flags = &h0
		Sub draw(g as Graphics)
		  ...
		  dim m as CDXYChartMBS = c.addMainChart(240)
		  
		  m.yAxis.setLinearScale 70,170
		  ...
		  // (ff0000)/blue (0000ff).
		  dim rsi as CDXYChartMBS = c.addRSI(75, 14, &h800080, 20, &hff0000, &h0000ff)
		  rsi.yAxis.setLinearScale 0,100
		  
		  // Append a 12-days momentum indicator chart (75 pixels high) using blue (0000ff)
		  // color.
		  dim mom as CDXYChartMBS = c.addMomentum(75, 12, &h0000ff)
		  mom.yAxis.setLinearScale -40,40
