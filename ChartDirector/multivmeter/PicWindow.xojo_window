...
#tag WindowCode
	#tag Event
		Sub Open()
		  ...
		  dim m as new CDLinearMeterMBS(60, 245, CDBaseChartMBS.silverColor, 0, -2)
		  ...
		  m.addText(30, 5, "Temp C", "arialbd.ttf", 8, &h000088, CDBaseChartMBS.kTopCenter).setBackground(&h9999ff)
