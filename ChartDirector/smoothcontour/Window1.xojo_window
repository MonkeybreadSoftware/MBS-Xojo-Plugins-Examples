		...
		Sub Open()
		  ...
		  for yIndex as integer = 0 to UBound(datay)
		    ...
		    for xIndex as integer = 0 to UBound(datax)
		      ...
		      dataZ(yIndex * 21 + xIndex) = sin(x / 2) + sin(y / 2)
		    next
		  next
		  ...
		  // vertical grid lines
		  call c.setPlotArea(75, 40, 400, 400, -1, -1, -1, c.dashLineColor(&h80000000, c.kDotLine), -1)
		  ...
		  dim cAxis as CDColorAxisMBS = layer.setColorAxis(495, 240, c.kLeft, 370, c.kRight)
