...
#tag WindowCode
	#tag Event
		Sub Open()
		  ...
		  dim c as new CDSurfaceChartMBS(720*f, 600*f)
		  
		  // Add a title to the chart using 20 points Times New Roman Italic font
		  call c.addTitle("Surface Energy Density   ", "timesi.ttf", 20*f)
		  
		  // Set the center of the plot region at (350, 280), and set width x depth x
		  // height to 360 x 360 x 270 pixels
		  c.setPlotRegion(350*f, 280*f, 360*f, 360*f, 270*f)
		  
		  // Set the data to use to plot the chart
		  c.setData(dataX, dataY, dataZ)
		  
		  // Spline interpolate data to a 80 x 80 grid for a smooth surface
		  c.setInterpolation(80*f, 80*f)
		  ...
		  dim ca as CDColorAxisMBS = c.setColorAxis(645*f, 270*f, c.kLeft, 200*f, c.kRight)
		  call ca.setLabelStyle "", 8*f
		  call ca.setwidth(15*f)
		  c.setWallThickness(10*f)
		  'call ca.setLinearScale -20.0, 20.0, 5
		  
		  // Set the x, y and z axis titles using 10 points Arial Bold font
		  call c.xAxis.setTitle("X (nm)", "arialbd.ttf", 10*f)
		  call c.yAxis.setTitle("Y (nm)", "arialbd.ttf", 10*f)
		  call c.zAxis.setTitle("Energy Density (J/m<*font,super*>2<*/font*>)", "arialbd.ttf", 10*f)
		  
		  c.xAxis.setLinearScale -10, 10, 5, 1
		  c.yAxis.setLinearScale -10, 10, 5, 1
		  c.zAxis.setLinearScale -20, 20, 5, 5
		  call c.xAxis.setLabelStyle "", 8*f
		  call c.yAxis.setLabelStyle "", 8*f
		  call c.zAxis.setLabelStyle "", 8*f
