...
#tag WindowCode
	#tag Event
		Sub Open()
		  ...
		  dim xData() as double = r.getSeries(20, 100, -10, 10)
		  dim yData() as double = r.getSeries(20, 100, -10, 10)
		  dim zData() as double = r.getSeries(20, 100, -10, 10)
		  
		  // Create a ThreeDScatterChart object of size 720 x 520 pixels
		  dim c as new CDThreeDScatterChartMBS(720, 520)
		  ...
		  dim g as cdThreeDScatterGroupMBS = c.addScatterGroup(xData, yData, zData, "", c.kGlassSphere2Shape, 13, c.kSameAsMainColor)
		  
		  // Add grey (888888) drop lines to the symbols
		  g.setDropLine(&c888888)
		  ...
		  dim a as CDColorAxisMBS = c.setColorAxis(645, 220, c.kLeft, 200, c.kRight)
		  a.setColorGradient()
