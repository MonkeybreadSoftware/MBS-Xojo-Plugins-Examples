...
#tag WindowCode
	#tag Event
		Sub Open()
		  ...
		  dim data(-1) as double = array(230, 140, 220, 330, 150.0)
		  
		  // We want to plot a waterfall chart showing the 4 quarters as well as the total
		  dim labels(-1) as string = array("Product 1", "Product 2", "Product 3", "Product 4", "Product 5", "Total")
		  ...
		  dim c as new CDXYChartMBS(500, 290, &hccccff, &h000000, 1)
		  
		  // Add a title to the chart using 13 points Arial Bold Itatic font, with white
		  // (ffffff) text on a deep blue (&h80) background
		  c.addTitle("Product Revenue - Year 2004", "arialbi.ttf", 13, &hffffff).setBackground(&h000080)
		  ...
		  layer = c.addBoxWhiskerLayer2(bTop, bBottom)
