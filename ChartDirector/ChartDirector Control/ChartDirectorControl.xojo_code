...
Inherits Canvas
	...
	#tag Method, Flags = &h21
		Private Sub Render(gWidth as integer, gHeight as integer)
		  ...
		  Current = Render(ViewPort, 1, gWidth, gHeight)
	...
	#tag Property, Flags = &h21
		Private DrawInfoDataSet As String
	#tag EndProperty

	#tag Property, Flags = &h21
		Private DrawInfoDataSetName As String
	#tag EndProperty

	#tag Property, Flags = &h21
		Private DrawInfoLabel As string
	#tag EndProperty

	#tag Property, Flags = &h21
		Private DrawInfoSector As String
	#tag EndProperty

	#tag Property, Flags = &h21
		Private DrawInfoTitle As String
	#tag EndProperty

	#tag Property, Flags = &h21
		Private DrawInfoValue As String
	#tag EndProperty
	...
	#tag Property, Flags = &h21
		Private DrawInfoXLabel As string
	#tag EndProperty

	#tag Property, Flags = &h21
		Private DrawInfoXValue As String
	#tag EndProperty
	...
	#tag Property, Flags = &h0
		ZoomPicture As Picture
	#tag EndProperty

	#tag Property, Flags = &h21
		Private ZoomTimer As timer
	#tag EndProperty
