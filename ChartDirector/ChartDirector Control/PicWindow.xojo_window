...
Begin Window PicWindow
   ...
   Placement       =   0
   Resizeable      =   True
   Title           =   "ChartDirector Control"
   Visible         =   True
   Width           =   1027
   Begin ChartDirectorControl a1
      AcceptFocus     =   False
      AcceptTabs      =   False
      AllowMove       =   True
      AllowZoom       =   True
   ...
   Begin Label StaticText2
      ...
      TabPanelIndex   =   0
      TabStop         =   True
      Text            =   "Click on values to change symbol color. Shift-Click and Option-Click to zoom."
      TextAlign       =   1
      TextColor       =   &c00000000
      TextFont        =   "SmallSystem"
      TextSize        =   0.0
...
#tag WindowCode
	...
	#tag MenuHandler
		Function PrintA2() As Boolean Handles PrintA2.Action
			a2.Print
			Return (True)
	...
	#tag MenuHandler
		Function PrintA3() As Boolean Handles PrintA3.Action
			a3.Print
			Return (True)
	...
	#tag MenuHandler
		Function PrintA4() As Boolean Handles PrintA4.Action
			a4.Print
			Return (True)
...
#tag Events a1
	#tag Event
		Function Render(ViewPort As CDViewPortManagerMBS, Factor As Double, Width As Integer, Height As Integer) As CDBaseChartMBS
		  CDBaseChartMBS.ScaleFactor = 2 // let plugin scale up for HiDPI
...
#tag Events a3
	#tag Event
		Function Render(ViewPort As CDViewPortManagerMBS, Factor As Double, Width As Integer, Height As Integer) As CDBaseChartMBS
		  ...
		  str(CDBaseChartMBS.ScaleFactor*f*22)+"*><*block,width="+_
		  str(CDBaseChartMBS.ScaleFactor*f*120)+"*>{label}<*/*><*block,width="+str(CDBaseChartMBS.ScaleFactor*f*40)+",halign=right*>{percent}<*/*>%")
