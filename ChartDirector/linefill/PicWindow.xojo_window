...
#tag WindowCode
	#tag Event
		Sub Open()
		  ...
		  dim legendBox as CDLegendBoxMBS = c.addLegend(c.getWidth / 2, title.getHeight, false, "arialbi.ttf", 10)
		  ...
		  dim plotArea as CDPlotAreaMBS = c.setPlotArea(70, 65, c.getWidth - 100, c.getHeight - 110, -1, -1, &hc0c0c0, &hc0c0c0, -1)
		  ...
		  c.packPlotArea(10, legendBox.getTopY + legendBox.getHeight, c.getWidth - 25, c.getHeight - 10)
