...
#tag WindowCode
	#tag Event
		Sub Open()
		  ...
		  dim m as new CDAngularMeterMBS(70, 90, 0, 0, -2)
		  ...
		  dim pattern1(-1) as string = array("E", " ", " ", " ", "F")
		  m.setScale(0, 100, pattern1)
		  ...
		  call m.addText(25, 35, "<*img="+m.getpath(FindFile("gas.gif"))+"*>")
