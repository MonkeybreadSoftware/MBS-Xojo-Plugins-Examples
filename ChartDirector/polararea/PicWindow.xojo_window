...
#tag WindowCode
	#tag Event
		Sub Open()
		  ...
		  dim labels(-1) as string = array("North", "North<*br*>East", "East", "South<*br*>East", "South", "South<*br*>West", "West", "North<*br*>West")
		  ...
		  c.addTitle("Polar Area Chart Demo", "arialbi.ttf", 15).setBackground(c.patternColor(FindFIle("wood.png")))
