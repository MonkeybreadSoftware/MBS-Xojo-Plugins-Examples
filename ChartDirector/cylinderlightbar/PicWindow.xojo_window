...
#tag WindowCode
	#tag Event
		Sub Open()
		  ...
		  call c.setPlotArea(60, 40, 480, 280, c.linearGradientColor(60, 40, 60, 280, &heeffee, &h008800), -1, &hffffff, &hffffff)
		  ...
		  c.yAxis2.setColors(c.kTransparent)
