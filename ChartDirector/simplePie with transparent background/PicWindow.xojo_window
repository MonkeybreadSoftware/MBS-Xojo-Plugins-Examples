...
#tag WindowCode
	#tag Event
		Sub Open()
		  ...
		  c = new CDPieChartMBS(360, 300, c.kTransparent)
		  ...
		  dim png as string = c.makeChart(c.kPNG)
		  
		  dim f as FolderItem = SpecialFolder.Desktop.Child("simplePie with transparent background.png")
		  dim b as BinaryStream = f.CreateBinaryFile("")
		  b.Write png
		  
		  // needs PNG plugin
		  Backdrop = PNGStringToPictureMBS(png)
