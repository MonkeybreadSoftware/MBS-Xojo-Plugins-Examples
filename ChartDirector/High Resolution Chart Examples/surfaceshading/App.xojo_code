...
Inherits Application
	...
	#tag Method, Flags = &h1
		Protected Sub CreateChart(img as integer, filename as string)
		  ...
		  dim c as new CDSurfaceChartMBS(f*380, f*400, &hffffff, &h888888)
		  
		  // Demonstrate various shading methods
		  call c.addTitle("11 x 11 Points - Spline Fitted to 50 x 50"+EndOfLine.unix+"Smooth Shading","",12*f)
		  c.setInterpolation(50, 50)
		  
		  // Set the center of the plot region at (175, 200), and set width x depth x
		  // height to 200 x 200 x 160 pixels
		  c.setPlotRegion(f*175, f*200, f*200, f*200, f*160)
		  
		  // Set the plot region wall thichness to 5 pixels
		  c.setWallThickness(f*5)
		  
		  c.yAxis.setLinearScale -10,10,5
		  c.xAxis.setLinearScale -10,10,5
		  c.zAxis.setLinearScale -20,20,5
