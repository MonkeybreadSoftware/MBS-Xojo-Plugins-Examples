...
#tag WindowCode
	#tag Event
		Sub Open()
		  const f=2 // scale factor, 1 for screen and 4 or more for printing
		  ...
		  c.zAxis.setLinearScale 20,55,5
		  ...
		  dim cAxis as CDColorAxisMBS = c.setColorAxis(f*95, f*100, c.kTopRight, f*160, c.kLeft)
		  ...
		  // border.
		  cAxis.setBoundingBox(&heeeeee, &h888888,f)
		  ...
		  call c.zAxis.setLabelStyle("arialbd.ttf",f*8)
		  call c.colorAxis.setLabelStyle("arialbd.ttf",f*8)
		  
		  // Set the x, y and z axis titles using deep blue (000088) 15 points Arial font
		  call c.xAxis.setTitle("Date/Time Axis", "ariali.ttf", f*15, &h000088)
		  call c.yAxis.setTitle("Label"+EndOfLine.unix+"Based"+EndOfLine.unix+"Axis", "ariali.ttf", f*15, &h000088)
		  call c.zAxis.setTitle("Numeric Axis", "ariali.ttf", f*15, &h000088)
