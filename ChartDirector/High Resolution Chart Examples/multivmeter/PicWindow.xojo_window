...
#tag WindowCode
	#tag Event
		Sub Open()
		  ...
		  dim m as new CDLinearMeterMBS(f*60, f*245, CDBaseChartMBS.silverColor, 0, -2*F)
		  ...
		  // meter)
		  m.setMeter(f*25, f*30, f*20, f*200)
		  ...
		  // reflect the values
		  dim c as CDMeterPointerMBS
		  
		  c=m.addPointer(value0, &h000080)
		  c.setShape m.kPencilPointer, 0.75,2
		  c=m.addPointer(value1, &h008000)
		  c.setShape m.kPencilPointer, 0.75,2
		  c=m.addPointer(value2, &h800000)
		  c.setShape m.kPencilPointer, 0.75,2
		  ...
		  m.addText(f*30, f*5, "Temp C", "arialbd.ttf", f*8, &h000088, CDBaseChartMBS.kTopCenter).setBackground(&h9999ff)
		  
		  me.Width=m.getWidth
		  me.height=m.getheight
