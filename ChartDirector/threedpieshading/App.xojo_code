...
Inherits Application
	#tag Event
		Sub Open()
		  ...
		  createChart(0, "threedpieshading0")
		  createChart(1, "threedpieshading1")
		  createChart(2, "threedpieshading2")
		  createChart(3, "threedpieshading3")
		  createChart(4, "threedpieshading4")
		  createChart(5, "threedpieshading5")
		  createChart(6, "threedpieshading6")
	...
	#tag Method, Flags = &h1
		Protected Sub CreateChart(img as integer, filename as string)
		  ...
		  dim c as new CDPieChartMBS(200, 200)
