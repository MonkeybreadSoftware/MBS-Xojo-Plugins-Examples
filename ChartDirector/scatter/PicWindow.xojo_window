...
#tag WindowCode
	#tag Event
		Sub Open()
		  ...
		  dim dataX1(-1) as double = array(6, 12, 4, 3.5, 7, 8, 9, 10, 12, 11, 8.0)
		  dim dataY1(-1) as double = array(65, 80, 40, 45, 70, 80, 80, 90, 100, 105.0, 60)
		  ...
		  // symbols
		  call c.addScatterLayer(dataX0, dataY0, "Genetically Engineered", c.kDiamondSymbol, 13, &hff9933)
		  
		  // Add a green (&h33ff33) scatter chart layer, using 11 pixel triangles as
		  // symbols
		  call c.addScatterLayer(dataX1, dataY1, "Natural", c.kTriangleSymbol, 11, &h33ff33)
