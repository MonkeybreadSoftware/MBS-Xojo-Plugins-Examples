...
#tag WindowCode
	...
	#tag Method, Flags = &h0
		Sub putresult(hasp as HASPHLMBS)
	...
	#tag Method, Flags = &h0
		Sub rundemo(featureid As  Integer)
		  ...
		  dim hasp As HASPHLMBS // Instance of the RB HASP object, wrapping the RB Plugin
		  ...
		  hasp=new HASPHLMBS(feature,vendor_code_DEMOMA)
		  putresult hasp
