...
#tag WindowCode
	...
	#tag Property, Flags = &h0
		thePageFormat As CPMPageFormatMBS
	#tag EndProperty

	#tag Property, Flags = &h0
		thePdfDocument As CGPDFDocumentMBS
	#tag EndProperty

	#tag Property, Flags = &h0
		thePrintSession As CPMPrintSessionMBS
	#tag EndProperty

	#tag Property, Flags = &h0
		thePrintSettings As CPMPrintSettingsMBS
	#tag EndProperty
	...
	#tag Event
		Sub Action()
		  ...
		  if file.Exists then
		    ...
		    thePrintSession  = New MyCPMPrintSessionMBS
		    if thePrintSession=nil then Return
		    if thePrintSession.Handle=0 then Return
		    ...
		    thePrintSession.UseSheets self
