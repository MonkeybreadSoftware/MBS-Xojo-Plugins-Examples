...
Inherits Application
	#tag Event
		Sub Open()
		  ...
		  props.Flags = props.kFlagContentType Or props.kFlagDeliveryMode
		  props.ContentType = "text/plain"
		  props.DeliveryMode = 2 // persistent delivery mode //
		  
		  
		  Dim ErrorCode As Integer = conn.BasicPublish(1, exchange, routingkey, False, False, props, messagebody)
		  If ErrorCode <> 0 Then
		    MsgBox "Failed to publish."
		    Return
		  Else
		    MsgBox "Sent"
		  End If
