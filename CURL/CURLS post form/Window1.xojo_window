...
Begin Window Window1
   ...
   Begin Label StaticText1
      ...
      TabPanelIndex   =   0
      TabStop         =   True
      Text            =   "This example does a multiple part post to a webservice"
      TextAlign       =   0
      TextColor       =   &c00000000
      TextFont        =   "System"
      TextSize        =   0.0
   ...
   Begin TextField URL
      ...
      TabPanelIndex   =   0
      TabStop         =   True
      Text            =   "http://www.monkeybreadsoftware.de/cgi-bin/FileUploadTest/upload.cgi"
      TextColor       =   &c00000000
      TextFont        =   "System"
      TextSize        =   0.0
      TextUnit        =   0
...
#tag WindowCode
	#tag Event
		Sub Open()
		  ...
		  f=SpecialFolder.Desktop.Child("UploadTest.rbp.zip")
	...
	#tag Method, Flags = &h21
		Private Sub DoUpload()
		  ...
		  buf=stream.Read(stream.Length)
		  
		  // add a section named filMyFile
		  // with a file named file.name
		  // and binary content in buf
		  d.FormAdd(d.kFormCopyName,"myfile", d.kFormBuffer, file.Name, d.kFormBufferPtr, buf, d.kFormBufferLength, lenb(buf))
		  d.FormFinish
