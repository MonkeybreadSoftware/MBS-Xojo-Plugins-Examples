...
Begin Window Window1
   ...
   Placement       =   0
   Resizeable      =   False
   Title           =   "CURL send email with SSL"
   Visible         =   True
   Width           =   604
...
#tag WindowCode
	#tag Method, Flags = &h21
		Private Sub DoUpload()
		  ...
		  d.OptionUseSSL = d.kFTPSSL_ALL // FTPSSL is the property name, but it's SSL for FTP, SMTP, POP3, IMAP etc.
		  ...
		  'd.OptionSSLCert = "/Users/cs/Desktop/smtprelaypool.pem" // path to certificate file
		  'd.OptionSSLVerifyPeer = 1
		  'd.OptionSSLVerifyHost = 1
		  
		  d.OptionSSLVersion = d.kSSLVersionDefault
		  d.OptionSSLSessionIDCache = false
		  ...
		  System.DebugLog "URL: "+d.OptionURL
		  System.DebugLog "From: "+d.OptionMailFrom
		  System.DebugLog "Username: "+d.OptionUsername
		  System.DebugLog "Password: "+d.OptionPassword
	...
	#tag Method, Flags = &h0
		Sub Upload()
		  ...
		  OptionURL = "smtps://"+server.Text+":465" // 465 is port for SSL
