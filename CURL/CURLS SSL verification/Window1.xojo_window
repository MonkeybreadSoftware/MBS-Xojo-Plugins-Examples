...
Begin Window Window1
   ...
   Begin TextField URL
      ...
      TabPanelIndex   =   0
      TabStop         =   True
      Text            =   "https://www.monkeybreadsoftware.de/images/mbs.jpg"
      TextColor       =   
      TextFont        =   "System"
      TextSize        =   0.0
      TextUnit        =   0
...
#tag WindowCode
	#tag Method, Flags = &h21
		Private Sub DoDownload()
		  dim cacert as FolderItem = findFile("cacert.pem")
		  ...
		  Canvas1.Backdrop = JPEGStringToPictureMBS(d.OutputData, true) // from JPEG plugin
