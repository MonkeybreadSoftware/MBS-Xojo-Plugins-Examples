...
#tag WindowCode
	#tag Method, Flags = &h0
		Sub QueryList()
		  ...
		  curl.OptionURL = "imaps://"+Server.Text+"/INBOX"
	...
	#tag Event
		Sub Change()
		  if me.ListIndex >= 0 then
		    ...
		    curl.CollectOutputData = true
		    curl.OptionURL = "imaps://"+Server.Text+"/INBOX;UID="+me.Cell(me.ListIndex,0)
		    curl.OptionUsername = Username.Text
		    curl.OptionPassword = Passwort.Text
		    curl.OptionVerbose = true
		    curl.YieldTime = true
		    ...
		    if e<>0 then
		      ...
		      self.content.text = ReplaceLineEndings(content, EndOfLine)
		    end if
