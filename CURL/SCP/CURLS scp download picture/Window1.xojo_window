...
Begin Window Window1
   ...
   Placement       =   0
   Resizeable      =   False
   Title           =   "CURLS scp download picture"
   Visible         =   True
   Width           =   604
   ...
   Begin TextField URL
      ...
      TabPanelIndex   =   0
      TabStop         =   True
      Text            =   "scp://name:password@192.168.1.80/users/cs/desktop/test.txt"
      TextColor       =   
      TextFont        =   "System"
      TextSize        =   0.0
      TextUnit        =   0
   ...
   Begin Label StaticText2
      ...
      TabPanelIndex   =   0
      TabStop         =   True
      Text            =   "Enter a scp URL in the format: ftp://name:password@domain.com/folder/file"
      TextAlign       =   0
      TextColor       =   
      TextFont        =   "System"
      TextSize        =   0.0
	...
	#tag Method, Flags = &h21
		Private Sub DoUpload()
		  ...
		  if e = 0 then
		    ...
		    dim message as string = d.DebugData
		    Break
		  end if
