...
Begin Window MainWindow
   ...
   Begin TextField URL
      ...
      TabPanelIndex   =   0
      TabStop         =   True
      Text            =   "ldap://ldap.forumsys.com/dc=example,dc=com??sub?(objectclass=*)"
      TextColor       =   &c00000000
      TextFont        =   "System"
      TextSize        =   0.0
      TextUnit        =   0
   ...
   Begin TextField User
      ...
      TabPanelIndex   =   0
      TabStop         =   True
      Text            =   "uid=tesla,dc=example,dc=com"
      TextColor       =   &c00000000
      TextFont        =   "System"
      TextSize        =   0.0
      TextUnit        =   0
...
#tag WindowCode
	#tag Method, Flags = &h21
		Private Sub Run()
		  ...
		  d.OptionUserName = User.Text
		  d.OptionPassword = pass.Text
