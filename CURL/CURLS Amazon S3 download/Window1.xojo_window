...
Begin Window Window1
   ...
   Placement       =   0
   Resizeable      =   False
   Title           =   "CURL S3 Picture Download"
   Visible         =   True
   Width           =   604
   ...
   Begin Label ResultText
      ...
      TabPanelIndex   =   0
      TabStop         =   True
      Text            =   "Please adjust parameters in code"
      TextAlign       =   0
      TextColor       =   
      TextFont        =   "System"
      TextSize        =   0.0
...
#tag WindowCode
	#tag Method, Flags = &h21
		Private Sub DoDownload()
		  ...
		  dim AWSAccessKeyId as String = "xxx"
		  dim AWSSecretAccessKey as String = "yyy"
		  dim Region as String = "eu-central-1"
		  dim BucketName as string = "zzz"
