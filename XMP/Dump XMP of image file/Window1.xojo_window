	...
	#tag Event
		Sub Open()
		  ...
		  if not file.Exists then
		    // please change file name above
		    Break
		  end if
		  
		  // use XMPFilesMBS to open file
		  dim flags as integer = XMPFilesMBS.kOpenForRead
		  ...
		  if xf.GetXMP(xmp, xmppacket, PacketInfo) then
		    ...
		    // and write to test file
		    dim outputfile as FolderItem = SpecialFolder.Desktop.Child("dump.txt")
