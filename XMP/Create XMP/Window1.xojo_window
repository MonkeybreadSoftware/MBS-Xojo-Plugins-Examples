...
#tag WindowCode
	#tag Event
		Sub Open()
		  Dim file As FolderItem = SpecialFolder.Desktop.Child("sample.png")
		  ...
		  // here we add XMP value:
		  xmp.AppendArrayItem ( xmp.kNS_XMP, "subject", kXMP_PropValueIsArray, "AAAA" )
