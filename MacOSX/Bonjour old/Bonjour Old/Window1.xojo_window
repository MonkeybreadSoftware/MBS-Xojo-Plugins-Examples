...
Begin Window Window1
   ...
   Begin TabPanel TabPanel1
      ...
      Scope           =   "0"
      SmallTabs       =   False
      TabDefinition   =   "Register\rLookup\rBrowse\rEnumerate"
      TabIndex        =   2
      TabPanelIndex   =   0
      TabStop         =   True
      TextFont        =   "System"
      ...
      Begin TextField Rtext
         ...
         Width           =   185
      End
      Begin PushButton TypelistButton
         AutoDeactivate  =   True
         Bold            =   False
         ButtonStyle     =   0
         Cancel          =   False
         Caption         =   "List of service types"
         Default         =   False
         Enabled         =   True
         Height          =   20
         HelpTag         =   ""
      ...
      Begin PushButton PushButton1
         ...
         Width           =   87
      End
      Begin RadioButton RadioEnumerate
         AutoDeactivate  =   True
         Bold            =   False
         Caption         =   "recommended registration domains"
         Enabled         =   True
         Height          =   20
         HelpTag         =   ""
         Index           =   0
      ...
      Begin RadioButton RadioEnumerate
         AutoDeactivate  =   True
         Bold            =   False
         Caption         =   "recommended browsing domains"
         Enabled         =   True
         Height          =   20
         HelpTag         =   ""
         Index           =   1
...
#tag WindowCode
	...
	#tag Event
		Sub Open()
		  ...
		  e=new MyBonjourDomainEnumerationMBS
	...
	#tag Property, Flags = &h0
		b As myBonjourbrowseMBS
	#tag EndProperty

	#tag Property, Flags = &h0
		e As myBonjourdomainEnumerationMBS
	#tag EndProperty

	#tag Property, Flags = &h0
		l As myBonjourlookupMBS
	#tag EndProperty

	#tag Property, Flags = &h0
		r As myBonjourregisterMBS
	#tag EndProperty


#tag EndWindowCode

#tag Events TypelistButton
	#tag Event
		Sub Action()
...
#tag Events PushButton4
	#tag Event
		Sub Action()
		  ...
		  // see http://www.zeroconf.org/Bonjour/txtrecords.html
