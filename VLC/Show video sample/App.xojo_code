...
Inherits Application
	#tag Event
		Sub Open()
		  // this example runs on Mac in 32 and 64 bit with VLC 2.0.9 libraries
		  
		  // it does currently not work for VLC 3.0 as initialization fails
