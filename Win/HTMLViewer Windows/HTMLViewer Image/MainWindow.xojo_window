...
Begin Window MainWindow
   ...
   Placement       =   0
   Resizeable      =   True
   Title           =   "HTMLViewer Image on Windows"
   Visible         =   True
   Width           =   1000
   Begin PushButton Image1Button
      AutoDeactivate  =   True
      Bold            =   False
      ButtonStyle     =   0
      Cancel          =   False
...
#tag WindowCode
	#tag Event
		Sub Open()
		  web.LoadURL "http://www.monkeybreadsoftware.de"
...
#tag Events Image1Button
	#tag Event
		Sub Action()
		  // resize web viewer to show full website without scrolling
	...
	#tag Event
		Sub Action()
		  If out.Backdrop = Nil Then
		    Beep
		  Else
		    Call ExportPicture(out.Backdrop)
		  End If
...
#tag Events PrintButton
	#tag Event
		Sub Action()
		  ...
		  Dim win As IEWindowMBS = web.IEWindowMBS
	...
	#tag EndEvent
#tag EndEvents
#tag Events Image2Button
	#tag Event
		Sub Action()
		  // get picture as shown
