...
Begin Window Window1
   ...
   Begin PushButton PushButton1
      ...
      ButtonStyle     =   0
      Cancel          =   False
      Caption         =   "Print Test Page on this printer"
      Default         =   False
      Enabled         =   True
      Height          =   20
      HelpTag         =   ""
...
#tag WindowCode
	#tag Event
		Sub Open()
		  // xojo's class to store printer setup
		  ps = new PrinterSetup
