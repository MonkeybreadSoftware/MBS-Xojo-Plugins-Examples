...
#tag WindowCode
	...
	#tag Property, Flags = &h1
		Protected voices(0) As winvoiceMBS
	#tag EndProperty

	#tag Property, Flags = &h1
		Protected w As winspeechMBS
	#tag EndProperty
...
#tag Bindings
	#tag BeginBinding
		SourceItem = ListBox1
		DestinationItem = PushButton4
		ItemType = enablingBinder
		ItemDescription = Enable PushButton4 when ListBox1 has a selection
