...
Begin Menu Menu
   ...
   Begin MenuItem UntitledMenu2
      ...
      Begin MenuItem UntitledMenu4
         ...
         Visible = True
      End
      Begin MenuItem FileNewSheetinExcel
         SpecialMenu = 0
         Index = -2147483648
         Text = "New Sheet in Excel"
         AutoEnabled = False
         AutoEnable = False
         Visible = True
      End
      Begin MenuItem FileCloseFIleinExcel
         SpecialMenu = 0
         Index = -2147483648
         Text = "Close FIle in Excel"
         AutoEnabled = False
         AutoEnable = False
         Visible = True
      End
   ...
   Begin MenuItem UntitledMenu0
      ...
      Begin MenuItem UntitledMenu8
         ...
         Visible = True
      End
      Begin AppleMenuItem UntitledMenu7
         SpecialMenu = 0
         Index = -2147483648
         Text = ""
         AutoEnabled = False
