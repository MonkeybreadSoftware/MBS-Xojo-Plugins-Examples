...
#tag WindowCode
	...
	#tag Method, Flags = &h0
		Sub update()
		    ...
		    call e.SetIconFile(WindowsFolderMBS.Child("explorer.exe"),1)
	...
	#tag Property, Flags = &h1
		Protected col As color
	#tag EndProperty

	#tag Property, Flags = &h1
		Protected e As MyWindowssystemtray
	#tag EndProperty
