...
#tag WindowCode
	#tag Event
		Sub Open()
		  DeviceManager = new WIADeviceManager2MBS
	...
	#tag Method, Flags = &h1
		Protected Sub Transfer()
		  ...
		  dim t as WIATransferMBS = it.Transfer
		  if t<>Nil then
		    dim c as new MyWIATransferCallbackMBS
		    ...
		    MsgBox "Transfer object not available."
		  end if
	...
	#tag Property, Flags = &h0
		DeviceManager As WIADeviceManager2MBS
	#tag EndProperty
