		...
		Sub DoTransfer()
		  ...
		  do
		    ...
		    if p<>Nil then
		      ...
		      dim f as FolderItem = SpecialFolder.Desktop.Child("TransferImage"+str(n)+".jpg")
		    ...
		    System.DebugLog "PendingTransferCount: "+str(t.PendingTransferCount)
		  loop until t.PendingTransferCount < 1
...
#tag Events PushButton8
	#tag Event
		Sub Action()
		  ...
		  dim p as Picture = t.Acquire(false, false)
