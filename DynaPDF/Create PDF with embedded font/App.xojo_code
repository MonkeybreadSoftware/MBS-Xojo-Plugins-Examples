...
Inherits Application
	#tag Event
		Sub Open()
		  ...
		  dim f as FolderItem = SpecialFolder.Desktop.Child("Create PDF with embedded font.pdf")
		  ...
		  // you may want to change font name
		  call pdf.SetFont "Zapfino", pdf.kfsItalic, 40.0, true, pdf.kcpMacRoman
