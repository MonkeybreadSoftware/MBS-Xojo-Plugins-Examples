...
Inherits Application
	#tag Event
		Sub Open()
		  ...
		  dim f as FolderItem = SpecialFolder.Desktop.Child("Create PDF with Zapf Dingbats.pdf")
		  ...
		  call pdf.SetFont "ZapfDingbats", pdf.kfsNone, 20.0, true, pdf.kcp1252
		  call pdf.WriteText 50.0, 180.0, "abcdef"
