...
Inherits Application
	#tag Event
		Sub Open()
		  ...
		  dim destfolder as FolderItem = SpecialFolder.Desktop.Child("Render Test 3")
		  ...
		  MsgBox "Render Test 3 done. Please check memory usage."
		      ...
		      if pdf.OpenImportFile(f, 0, "")=0 then
		        if pdf.ImportPDFFile(1, 1.0, 1.0)>0 then
		          ...
		          for i as integer = 1 to PageCount
		            ...
		            // render page to fit given size and matrix
		            dim m as new DynapdfMatrixMBS
		            
		            m.Translate(250,250) // move to middle
		            m.Scale(0.5,0.5)     // scale by 50%
		            
		            
		            dim out as Picture = pdf.RenderPagePicture(i, 1000, 1000, 2, m)
