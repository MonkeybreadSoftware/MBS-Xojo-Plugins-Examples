...
Inherits Application
	#tag Event
		Sub Open()
		  ...
		  dim f as FolderItem = SpecialFolder.Desktop.Child("Create PDF with Errors.pdf")
		  ...
		  // first load a valid font so loading an invalid will still print text
		  call pdf.SetFont "Helvetica", pdf.kfsItalic, 20.0, true, pdf.kcp1252
