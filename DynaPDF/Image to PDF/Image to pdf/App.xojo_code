...
Inherits Application
	#tag Event
		Sub Open()
		  ...
		  f=GetOpenFolderItem(FileTypes.Jpeg+FileTypes.Tiff)
	...
	#tag Method, Flags = &h1
		Protected Sub CreatePDFwithImage(source as folderitem, dest as folderitem)
		  ...
		  call pdf.ReadImageFormat(source, iWidth, iHeight, iBitsPerPixel, iUseZip)
		  ...
		  call pdf.SetUseSwapFile(False, 256*1024)
		  ...
		  dim tmpl as integer=pdf.InsertImageEx(0, 0, dWidth, dHeight, source, 1)
		  if tmpl<0 then
