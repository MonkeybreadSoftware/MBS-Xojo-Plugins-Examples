...
Begin Window MainWindow
   ...
   Placement       =   0
   Resizeable      =   True
   Title           =   "ListBox Report"
   Visible         =   True
   Width           =   600
   Begin ReportDataListBox PrintableListBox
      AutoDeactivate  =   True
      ...
      _ScrollWidth    =   -1
   End
   Begin PushButton PrintPreviewButton
      AutoDeactivate  =   True
      Bold            =   False
      ButtonStyle     =   0
      Cancel          =   False
...
#tag Events PDFButton
	#tag Event
		Sub Action()
		  ...
		  // optionally put a background.pdf on desktop
		  Dim fi As FolderItem = SpecialFolder.Desktop.Child("background.pdf")
