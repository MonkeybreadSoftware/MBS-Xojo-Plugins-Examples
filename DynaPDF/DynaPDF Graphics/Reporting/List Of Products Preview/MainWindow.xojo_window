...
Begin Window MainWindow
   ...
   Begin Label Label1
      ...
      TabPanelIndex   =   0
      TabStop         =   True
      Text            =   "This example runs a SQL query and then displays the data in a ContainerControl to preview and print."
      TextAlign       =   0
      TextColor       =   &c00000000
      TextFont        =   "System"
      TextSize        =   0.0
      ...
      Width           =   558
   End
   Begin ReportPreviewContainer ReportPreviewContainer1
      AcceptFocus     =   False
      AcceptTabs      =   True
      AutoDeactivate  =   True
      BackColor       =   &cFFFFFF00
