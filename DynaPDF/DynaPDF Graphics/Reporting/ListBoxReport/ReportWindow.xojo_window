...
Begin Window ReportWindow
   ...
   Begin Canvas ReportCanvas
      ...
      Width           =   560
   End
   Begin PushButton PreviousPageButton
      AutoDeactivate  =   True
      Bold            =   False
      ButtonStyle     =   0
      Cancel          =   False
...
#tag WindowCode
	...
	#tag Property, Flags = &h21
		Private mRptDoc As Reports.RBReportDocument
	#tag EndProperty
	...
	#tag ComputedProperty, Flags = &h0
		...
		#tag Setter
			...
			End Set
		#tag EndSetter
		RptDoc As Reports.RBReportDocument
