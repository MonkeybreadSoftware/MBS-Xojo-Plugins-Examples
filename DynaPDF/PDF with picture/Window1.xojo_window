...
#tag WindowCode
	#tag Event
		Sub Open()
		  ...
		  dim file as FolderItem=SpecialFolder.Desktop.Child("PDF with picture.pdf")
		  ...
		  // make a PNG of that picture
		  dim buf as string=PictureToPNGStringMBS(p,0)
		  ...
		  // add image to pdf
		  call d.InsertImageFromBuffer(x,y,w,h,buf,1)
