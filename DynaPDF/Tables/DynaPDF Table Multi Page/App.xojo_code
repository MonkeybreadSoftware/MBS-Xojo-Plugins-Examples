...
Inherits Application
	...
	#tag Method, Flags = &h0
		Sub AddArticleTable(pdf as DynaPDFMBS, record as Customer)
		  ...
		  dim sum as Double
		  do
		    dim y as double = table.DrawTable( 55.0, 350.0, 350) + 352.0
	...
	#tag Method, Flags = &h0
		Sub CreateInvoices()
		  ...
		  dim ofile as FolderItem = SpecialFolder.Desktop.Child("DynaPDF Table Invoice Multi Page Example.pdf")
