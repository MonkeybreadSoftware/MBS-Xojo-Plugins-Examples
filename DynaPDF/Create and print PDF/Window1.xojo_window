...
Begin Window Window1
   ...
   Begin Label StaticText1
      ...
      TabPanelIndex   =   0
      TabStop         =   True
      Text            =   "Printing a PDF directly is difficult. \rBut on Windows you can use Acrobat Reader if installed to ask it for printing a PDF.\rAnd on Mac you can use CoreGraphics PDF functions to draw a PDF to a printer environment."
      TextAlign       =   0
      TextColor       =   
      TextFont        =   "System"
      TextSize        =   0.0
...
#tag WindowCode
	#tag Method, Flags = &h0
		Sub print(f as FolderItem, ShowDialog as Boolean=true)
		  if TargetWin32 then
		    
		    if f=nil or f.Exists=false then
		      MsgBox "PDF file is missing."
		      Return
		    end if
		    ...
		    if len(s)=0 then
		      ...
		      if ShowDialog then
		        shell.Execute s+" /p """+f.NativePath+""""
		      else
		        shell.Execute s+" /h /p """+f.NativePath+""""
		      end if
		    end if
...
#tag Events PushButton1
	#tag Event
		Sub Action()
		  ...
		  dim d as new date
		  dim f as FolderItem=SpecialFolder.Desktop.Child("Create and print PDF.pdf")
