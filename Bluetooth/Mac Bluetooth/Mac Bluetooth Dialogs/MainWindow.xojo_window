...
Begin Window MainWindow
   ...
   Placement       =   0
   Resizeable      =   False
   Title           =   "Bluetooth Dialogs"
   Visible         =   True
   Width           =   600
   Begin PushButton ChooseDeviceButton
      AutoDeactivate  =   True
      Bold            =   False
      ButtonStyle     =   0
      Cancel          =   False
      ...
      Width           =   141
   End
   Begin PushButton ChooseServiceButton
      AutoDeactivate  =   True
      Bold            =   False
      ButtonStyle     =   0
      Cancel          =   False
...
#tag WindowCode
	...
	#tag Property, Flags = &h0
		DeviceSelectorController As IOBluetoothDeviceSelectorController
	#tag EndProperty
...
#tag Events ChooseDeviceButton
	...
	#tag EndEvent
#tag EndEvents
#tag Events ChooseServiceButton
	#tag Event
		Sub Action()
