	...
	#tag Event
		Sub Action()
		  ...
		  try
		    ...
		    // we used Microsoft SQL Server 2008 and run app on Linux to test this
		    
		    Dim cs As String = "DRIVER={libtdsodbc.so};Server="+iServer.Text+";UId="+iUser.Text+";PWD="+iPass.Text+";Database="+iDatabaseName.Text+";TDS_VERSION=7.2;Port="+iPort.Text
		    // alternative way is with full path to libtdsodbc.so in connection string
		    ...
		    if con.Connect then
		      ...
		      // add time stamp
		      'con.SQLExecute "insert into "+iTable.text+" ("+iColumn.text+") VALUES (SYSUTCDATETIME())"
		      ...
		      'else
		      'MsgBox r.IdxField(1).name+": "+r.IdxField(1).StringValue
		      'end if
		      ...
		      MsgBox "not connected: "+con.errorMessage
