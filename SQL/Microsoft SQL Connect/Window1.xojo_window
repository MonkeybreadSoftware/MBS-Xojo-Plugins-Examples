...
#tag Events PushButton1
	#tag Event
		Sub Action()
		  ...
		  // connects to Microsoft SQL Server on Windows. Example must run on Windows to use SQLNCLI!
		  // 
		  ...
		  Try
		    ...
		    con.Connect(server.text,user.text,password.text,SQLConnectionMBS.kSQLServerClient)
