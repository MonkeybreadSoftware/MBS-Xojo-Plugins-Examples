...
Begin Window Window1
   ...
   Begin TextField server
      ...
      TabPanelIndex   =   0
      TabStop         =   True
      Text            =   "Windows7PC\\SQLEXPRESS@test"
      TextColor       =   
      TextFont        =   "System"
      TextSize        =   0.0
      TextUnit        =   0
   ...
   Begin Label StaticText4
      ...
      TabPanelIndex   =   0
      TabStop         =   True
      Text            =   "PcName\\SqlServerInstanceName@DatabaseName"
      TextAlign       =   0
      TextColor       =   
      TextFont        =   "System"
      TextSize        =   0.0
...
#tag WindowCode
	#tag Note, Name = Stored Procedure
		-- below our test stored procedure for Microsoft SQL Server. Returns number plus 5
		...
		Sub Action()
		  ...
		  try
		    ...
		    if con.Connect then
		      ...
		      // normal
		      'dim sql as string = "EXEC dbo.Test 6"
