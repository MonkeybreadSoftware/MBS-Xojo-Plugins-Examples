	...
	#tag Event
		Sub Open()
		  ...
		  try
		    ...
		    #if TargetWin32 then
		      con.Option(con.kOptionLibrarySQLite) = "sqlcipher.dll"
		    #elseif TargetLinux
		      con.Option(con.kOptionLibrarySQLite) = "sqlcipher.so"
		    #elseif TargetMachO then
		      con.Option(con.kOptionLibrarySQLite) = "sqlcipher.dylib"
		    #else
		      ?
		    #endif
