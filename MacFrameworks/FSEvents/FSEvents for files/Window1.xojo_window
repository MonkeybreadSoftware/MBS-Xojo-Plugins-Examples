...
Begin Window Window1
   ...
   Begin ListBox ListBox1
      ...
      Index           =   -2147483648
      InitialParent   =   ""
      InitialValue    =   "Path	Flags	EventID"
      Italic          =   False
      Left            =   20
      LockBottom      =   True
...
#tag WindowCode
	...
	#tag Event
		Sub Open()
		  ...
		  f=new FSEvents(SpecialFolder.Desktop, eventid, latency, flags)
		  
		  // show description for debugging
		  'MsgBox f.Description
		  // and on console (stderr)
		  'f.Show
