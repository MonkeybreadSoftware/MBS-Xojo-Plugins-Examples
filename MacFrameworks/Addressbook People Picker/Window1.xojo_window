...
#tag Events CocoaControlMBS1
	#tag Event
		Function GetView() As NSViewMBS
		  m = new MyABPeoplePickerViewMBS(0,0,me.Width, me.Height)
		  m.l = list
		  m.AddProperty ABAddressBookMBS.kABEmailProperty
		  m.AddProperty ABAddressBookMBS.kABPhoneProperty
