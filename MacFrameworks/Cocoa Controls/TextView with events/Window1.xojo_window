...
Begin Window Window1
   ...
   Begin Label StaticText1
      ...
      TabPanelIndex   =   0
      TabStop         =   True
      Text            =   "You can't type an a above as we filter it."
      TextAlign       =   0
      TextColor       =   
...
#tag Events CocoaControlMBS1
	#tag Event
		Function GetView() As NSViewMBS
		  ...
		  n=new MyNSTextViewMBS(0,0,me.Width,me.Height)
