...
Begin Window Window1
   ...
   Begin BevelButton BevelButton1
      ...
      Bold            =   False
      ButtonType      =   0
      Caption         =   "authenticateLocalPlayer"
      CaptionAlign    =   3
      CaptionDelta    =   0
      CaptionPlacement=   1
      Enabled         =   True
...
#tag WindowCode
	#tag Event
		Sub Open()
		  // install somewhere globally to get events there
		  
		  gameKit = new MyGameKitMBS
	...
	#tag Method, Flags = &h0
		Sub Check()
		  dim localPlayer as GKLocalPlayerMBS = GKLocalPlayerMBS.localPlayer
	...
	#tag Property, Flags = &h0
		gameKit As MyGameKitMBS
	#tag EndProperty

	#tag Property, Flags = &h0
		localPlayer As GKLocalPlayerMBS
	#tag EndProperty
...
#tag Events BevelButton1
	#tag Event
		Sub Action()
		  window1.Listbox1.AddRow "authenticate local player..."
