...
Begin Window MainWindow
   ...
   Begin Label StaticText1
      ...
      TabPanelIndex   =   0
      TabStop         =   True
      Text            =   "Looks like you need a wireless network to get locations."
      TextAlign       =   0
      TextColor       =   
      TextFont        =   "System"
      TextSize        =   0.0
...
#tag WindowCode
	...
	#tag Event
		Sub Open()
		  ...
		  LocationManager.desiredAccuracy=CLLocationMBS.kCLLocationAccuracyBest
	...
	#tag Property, Flags = &h0
		LocationManager As MyLocationManager
	#tag EndProperty
