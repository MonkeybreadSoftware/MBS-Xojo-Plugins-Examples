...
#tag WindowCode
	...
	#tag Method, Flags = &h21
		Private Sub DecompressFile(fi as FolderItem, fo as FolderItem, chunk as integer)
		  ...
		  z=new BZip2DecompressMBS(chunk)
	...
	#tag Method, Flags = &h21
		Private Sub TestFunction()
		  ...
		  for i as integer=1 to 10
		    ...
		    dim compressed as string = CompressBZip2MBS(input,9)
		    
		    Listbox1.AddRow "   Compressed   "+str(lenb(compressed))+" bytes"
		    
		    dim Decompressed as string = DecompressBZip2MBS(compressed, len+1000)
