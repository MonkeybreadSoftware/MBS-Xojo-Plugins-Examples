...
Inherits WebFrameLoadDelegateMBS
	#tag Event
		Function windowScriptObjectAvailable(WebView as WebViewMBS, windowScriptObject as WebScriptObjectMBS) As boolean
		  // Install an Object called "MyBrowser" on the javascript document object
		  // Any function call inside will tricker callback event
		  windowScriptObject.setWebScriptCallback "Pe8Pe", App.htmlEventsCallBack
