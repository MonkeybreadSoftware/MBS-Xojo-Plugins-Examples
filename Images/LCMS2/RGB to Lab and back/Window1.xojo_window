...
#tag WindowCode
	...
	#tag Method, Flags = &h0
		Sub test(canvas1 as canvas, canvas2 as canvas, c as color, info as Label, intent as integer)
		  ...
		  ' ... fill c
		  mi=New MemoryBlock(3) // RGB
		  mo=New MemoryBlock(3) // LAB
		  ...
		  if ct.Transform(mi,mo,1) then
		    ...
		    // A,B = 128 is 0 point
		    // 
		    dim L as integer = mo.UInt8Value(0) // L
		    dim A as integer = mo.UInt8Value(1) // A
		    dim B as integer = mo.UInt8Value(2) // B
