...
Inherits Application
	...
	#tag Method, Flags = &h0
		Sub Convert1(InputFile as FolderItem, OutputFile as FolderItem, ICCProfile as FolderItem)
		  ...
		  dim Intent as integer = LCMS2MBS.kINTENT_RELATIVE_COLORIMETRIC
		  dim Flags  as integer = LCMS2MBS.kcmsFLAGS_BLACKPOINTCOMPENSATION
		  
		  dim ct as LCMS2TransformMBS = LCMS2TransformMBS.CreateTransform(InputProfile, InputFormat, OutputProfile, OutputFormat, intent, flags)
