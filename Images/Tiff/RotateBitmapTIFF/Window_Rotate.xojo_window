...
Begin Window Window_Rotate
   ...
   Placement       =   2
   Resizeable      =   True
   Title           =   "Rotate Bitmap Tiff Test"
   Visible         =   True
   Width           =   332
   Begin PushButton PushButton_SelectTiff
      AutoDeactivate  =   True
      Bold            =   False
      ButtonStyle     =   0
      Cancel          =   False
      ...
      Width           =   80
   End
   Begin PopupMenu PopupMenu_Degree
      AutoDeactivate  =   True
      Bold            =   False
      DataField       =   ""
      DataSource      =   ""
      ...
      Width           =   80
   End
   Begin PushButton PushButton_Rotate
      AutoDeactivate  =   True
      Bold            =   False
      ButtonStyle     =   0
      Cancel          =   False
      ...
      Width           =   80
   End
   Begin TextField TextField_TiffName
      AcceptTabs      =   False
      Alignment       =   0
      AutoDeactivate  =   True
...
#tag Events PushButton_SelectTiff
	#tag Event
		Sub Action()
