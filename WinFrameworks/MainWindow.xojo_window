...
Begin Window MainWindow
   ...
   Placement       =   0
   Resizeable      =   True
   Title           =   "WinFileDialogObserver Test"
   Visible         =   True
   Width           =   600
   Begin CheckBox CheckEnable
      AutoDeactivate  =   True
      Bold            =   False
      Caption         =   "Enable"
      DataField       =   ""
...
#tag WindowCode
	#tag Event
		Sub Open()
		  Observer = New MyWinFileDialogObserver
	...
	#tag Property, Flags = &h0
		Observer As MyWinFileDialogObserver
	#tag EndProperty


#tag EndWindowCode

#tag Events CheckEnable
	#tag Event
		Sub Action()
		  MyWinFileDialogObserver.Enabled = Me.Value
