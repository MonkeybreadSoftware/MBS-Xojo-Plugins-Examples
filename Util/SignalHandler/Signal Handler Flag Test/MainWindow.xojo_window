...
Begin Window MainWindow
   ...
   Begin Label Label1
      ...
      TabPanelIndex   =   0
      TabStop         =   True
      Text            =   "Please run app on Mac or Linux and try to kill it with kill command."
      TextAlign       =   0
      TextColor       =   
      TextFont        =   "System"
      TextSize        =   0.0
...
#tag WindowCode
	...
	#tag Constant, Name = SIGABRT, Type = Double, Dynamic = False, Default = \"6", Scope = Public
	#tag EndConstant

	#tag Constant, Name = SIGILL, Type = Double, Dynamic = False, Default = \"4", Scope = Public
	#tag EndConstant

	#tag Constant, Name = SIGKILL, Type = Double, Dynamic = False, Default = \"9", Scope = Public
	#tag EndConstant

	#tag Constant, Name = SIGQUIT, Type = Double, Dynamic = False, Default = \"3", Scope = Public
	#tag EndConstant
