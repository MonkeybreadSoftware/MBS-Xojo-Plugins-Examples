...
#tag WindowCode
	#tag Event
		Sub Open()
		  ...
		  test "%f", 1.234, de // German
		  test "%f", 1.234, en // US English
		  test "%f", 1.234, fr // French
		  
		  test "%f", 1.0 // default locale
		  test "%f", 1.0, de // German
		  test "%f", 1.0, en // US English
		  test "%f", 1.0, fr // French
		  
		  
		  // one before comma, 2 after comma
		  test "%1.2f", 1.234 // default locale
		  test "%1.2f", 1.234, de // German
		  test "%1.2f", 1.234, en // US English
		  test "%1.2f", 1.234, fr // French
		  
		  
		  
		  // test exceptions
		  test "%f%f", 1.23, fr // French
		  test "%f", 1.23, "xxx" // invalid locale
		  test "%s", 1.23, en // French
