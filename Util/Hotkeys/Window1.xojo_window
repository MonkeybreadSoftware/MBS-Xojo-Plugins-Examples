...
Begin Window Window1
   ...
   Begin Label StaticText1
      ...
      TabPanelIndex   =   0
      TabStop         =   True
      Text            =   "If you press the key combination shift-option-return this window will change it's collapse state.\rControl-F5 triggers event and shows message box."
      TextAlign       =   0
      TextColor       =   
      TextFont        =   "System"
      TextSize        =   0.0
...
#tag WindowCode
	...
	#tag Property, Flags = &h1
		Protected HotKeyF5 As HotKeyMBS
	#tag EndProperty

	#tag Property, Flags = &h1
		Protected HotKeyReturn As MyHotKey
	#tag EndProperty
