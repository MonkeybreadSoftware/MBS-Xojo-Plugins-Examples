...
Begin Window Window1
   ...
   Begin Label StaticText1
      ...
      TabPanelIndex   =   0
      TabStop         =   True
      Text            =   "Run Server and Client app. Type here:"
      TextAlign       =   0
      TextColor       =   
      TextFont        =   "System"
      TextSize        =   0.0
...
#tag WindowCode
	#tag Event
		Sub Open()
		  ...
		  if s.CreateSharedMemory("mbstest", 5000) then
		    // ok
