...
Protected Class JSONItem_MTC
	...
	#tag Method, Flags = &h0
		Sub Operator_Convert(arr() As Boolean)
		  self.Constructor()
	...
	#tag Method, Flags = &h0
		Sub Operator_Convert(arr() As Currency)
		  self.Constructor()
	...
	#tag Method, Flags = &h0
		Sub Operator_Convert(arr() As Double)
		  self.Constructor()
	...
	#tag Method, Flags = &h0
		Sub Operator_Convert(arr() As Int32)
		  self.Constructor()
	...
	#tag Method, Flags = &h0
		Sub Operator_Convert(arr() As Int64)
		  self.Constructor()
	...
	#tag Method, Flags = &h0
		Sub Operator_Convert(arr() As Object)
		  self.Constructor()
	...
	#tag Method, Flags = &h0
		Sub Operator_Convert(arr() As Single)
		  self.Constructor()
	...
	#tag Method, Flags = &h0
		Sub Operator_Convert(arr() As String)
		  self.Constructor()
	...
	#tag Method, Flags = &h0
		Sub Operator_Convert(arr() As Text)
		  self.Constructor()
	...
	#tag Method, Flags = &h21
		Private Sub Validate(ByRef value As Variant)
		  ...
		  dim isGood as boolean = true // Assume it is
	...
	#tag Constant, Name = kDefaultDecimalFormat, Type = String, Dynamic = False, Default = \"-0.0##############", Scope = Public
	#tag EndConstant
