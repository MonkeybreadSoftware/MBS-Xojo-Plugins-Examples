...
Begin Window Window1
   ...
   Begin PushButton PushButton1
      ...
      ButtonStyle     =   0
      Cancel          =   False
      Caption         =   "Run a thread that calls DelayMBS"
      Default         =   False
      Enabled         =   True
      Height          =   20
      HelpTag         =   ""
   ...
   Begin Label StaticText1
      ...
      TabPanelIndex   =   0
      TabStop         =   True
      Text            =   "This progress bar shows if we are still executing the main loop:"
      TextAlign       =   1
      TextColor       =   
      TextFont        =   "System"
      TextSize        =   0.0
   ...
   Begin Timer Timer1
      ...
      TabPanelIndex   =   "0"
   End
   Begin CheckBox CheckPauseThreads
      AutoDeactivate  =   True
      Bold            =   False
      Caption         =   "Pause other RB threads"
      DataField       =   ""
      DataSource      =   ""
      Enabled         =   True
      Height          =   20
      ...
      Width           =   181
   End
   Begin CheckBox CheckPauseProgressbar
      AutoDeactivate  =   True
      Bold            =   False
      Caption         =   "Pause progressbar"
      DataField       =   ""
      DataSource      =   ""
      Enabled         =   True
      Height          =   20
...
#tag Events Thread1
	#tag Event
		Sub Run()
		  ...
		  const DelayDontRBYield = 2    // Don't give REALbasic time for other REALbasic threads
		  ...
		  if CheckPauseThreads.Value then
		    mode=mode+2
		  end if
		  
		  if CheckPauseProgressbar.Value then
		    mode=mode+32
		  end if
		  
		  DelayMBS 20,mode //just hang around for 20 seconds
		  beep //confirm we finished
