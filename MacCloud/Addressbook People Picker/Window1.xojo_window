...
Begin Window Window1
   ...
   Visible         =   True
   Width           =   955
   Begin ABPeoplePickerViewControlMBS picker
      AutoDeactivate  =   True
      Enabled         =   True
      Height          =   433
      HelpTag         =   ""
...
#tag Events picker
	#tag Event
		Sub Open()
		  ...
		  // customize?
		  m.allowsMultipleSelection = true
		  m.allowsGroupSelection = true
	...
	#tag Event
		Sub GroupDoubleClick()
		  ...
		  dim r() as ABRecordMBS = m.selectedRecords
		  if UBound(r)>=0 then
