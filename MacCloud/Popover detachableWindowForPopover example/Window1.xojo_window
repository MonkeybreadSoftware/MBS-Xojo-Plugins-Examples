	...
	#tag Event
		Sub Action()
		  ...
		  if pw<>nil then
		    ...
		    if pw.detachableWindow <> nil then
		      // detached
		  ...
		  // we use a PopoverWindow instance here just to get the view from there.
		  cw = new PopoverWindow
		  vc = new NSViewControllerMBS
		  vc.view = cw.ContainerControl11.NSViewMBS
		  
		  pw = new MyNSPopoverMBS
		  pw.c = cw.ContainerControl11
		  pw.animates = true
