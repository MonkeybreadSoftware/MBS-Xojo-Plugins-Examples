...
Begin Window MainWindow
   ...
   Placement       =   0
   Resizeable      =   True
   Title           =   "AVCaptureDevice Authorization"
   Visible         =   True
   Width           =   600
   Begin Listbox List
      AutoDeactivate  =   True
      ...
      _ScrollWidth    =   -1
   End
   Begin PushButton AudioButton
      AutoDeactivate  =   True
      Bold            =   False
      ButtonStyle     =   0
      Cancel          =   False
      Caption         =   "Request Audio"
      Default         =   False
      Enabled         =   True
      Height          =   20
      HelpTag         =   ""
      ...
      Width           =   118
   End
   Begin PushButton VideoButton
      AutoDeactivate  =   True
      Bold            =   False
      ButtonStyle     =   0
      Cancel          =   False
      Caption         =   "Request Video"
      Default         =   False
      Enabled         =   True
      Height          =   20
      HelpTag         =   ""
