...
Inherits NSKeyValueObserverMBS
	#tag Event
		Function observedValueForKeyPathChanged(keyPath as string, target as variant, change as dictionary, context as variant, ChangeNSDictionaryRef as Integer) As boolean
		  ...
		  if contextString = MovieOverlay.AVSPPlayerItemStatusContext then
		    ...
		    case AVPlayerItemMBS.AVPlayerItemStatusFailed
		      ...
		      // show error
		      MovieOverlay.stopLoadingAnimationAndHandleError MovieOverlay.player.currentItem.error
		  ...
		  elseif contextString = MovieOverlay.AVSPPlayerLayerReadyForDisplay then
		    ...
		    if b then
		      ...
		      MovieOverlay.stopLoadingAnimationAndHandleError nil
		      MovieOverlay.playerLayer.Hidden = false
		      MovieOverlay.playerLayer.setNeedsDisplay
		    end if
