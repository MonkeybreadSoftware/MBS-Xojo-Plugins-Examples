	...
	#tag Event
		Sub Open()
		  ...
		  if not f.Exists then
		    MsgBox "This app looks for test.m4v on your desktop..."
		    break
		    quit
		    Return
		  end if
		  ...
		  Backdrop = RenderSamplesMBS(SampleData, SampleData.Size / 2, 1, me.Width, me.Height, 1, &c88B5C4, &c274C5A, &c203F4E, 15)
		End Sub
	#tag EndEvent
