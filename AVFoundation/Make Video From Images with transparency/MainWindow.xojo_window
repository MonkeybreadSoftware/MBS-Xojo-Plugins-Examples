...
#tag WindowCode
	#tag Event
		Sub Open()
		  ...
		  file = SpecialFolder.Desktop.Child("test.mov")
		  if file.Exists then file.Delete
		  
		  dim error as NSErrorMBS
		  videoWriter = New AVAssetWriterMBS(file, AVFoundation.AVFileTypeQuickTimeMovie, error)
		  ...
		  videoSettings.Value(AVFoundation.AVVideoCodecKey) = AVFoundation.AVVideoCodecAppleProRes4444
