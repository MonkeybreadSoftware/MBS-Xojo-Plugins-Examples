...
Begin Window Window1
   ...
   Begin Label StaticText1
      ...
      TabPanelIndex   =   0
      TabStop         =   True
      Text            =   "If you press the key combination shift-option-return this window will change it's collapse state."
      TextAlign       =   0
      TextColor       =   
      TextFont        =   "System"
      TextSize        =   0.0
...
#tag WindowCode
	...
	#tag Property, Flags = &h1
		Protected MyEvents1 As myEvents
	#tag EndProperty

	#tag Property, Flags = &h1
		Protected p As CarbonHotKeyMBS
	#tag EndProperty
