...
Begin Window Window1
   ...
   Placement       =   0
   Resizeable      =   False
   Title           =   "Midi Send Keys"
   Visible         =   True
   Width           =   483
   Begin BevelButton notes
      AcceptFocus     =   False
      AutoDeactivate  =   True
      BackColor       =   &c00000000
      Bevel           =   0
   ...
   Begin Label StaticText1
      ...
      TabPanelIndex   =   0
      TabStop         =   True
      Text            =   "This application can send midi notes which SimpleSynth can receive and play."
      TextAlign       =   0
      TextColor       =   
...
#tag WindowCode
	...
	#tag Method, Flags = &h0
		Sub InitMIDI()
		  ...
		  currentdest = client.CreateSource(NewCFStringMBS("mysource"))
	...
	#tag Property, Flags = &h0
		realDestinations(-1) As MIDIEndpointMBS
	#tag EndProperty
