	...
	#tag Event
		Sub Open()
		  if targetmacho then
		    ...
		    msgBox "This target is for Mac OS X only."
		  end if
...
#tag Events Timer1
	#tag Event
		Sub Action()
		  ...
		  if mode=2 then
		    call RemoteControlMBS.MacMoveMouse sx,sy
		  end if
		  
		  if mode=3 then
		    call RemoteControlMBS.MacMouseClick sx,sy,true,true
		  end if
		  
		  if mode=4 then
		    call RemoteControlMBS.MacMouseClick sx,sy,true,False
		  end if
		  ...
		  if mode=6 then
		    call RemoteControlMBS.MacMouseClick dx,dy,true,true
		  end if
		  
		  if mode=7 then
		    call RemoteControlMBS.MacMouseClick dx,dy,true,false
		  end if
		  
		  if mode=8 then
		    call RemoteControlMBS.MacMoveMouse cx,cy
		  end if
