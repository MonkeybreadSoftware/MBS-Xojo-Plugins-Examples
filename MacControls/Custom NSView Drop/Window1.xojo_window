...
#tag Events CocoaControlMBS1
	#tag Event
		Function GetView() As NSViewMBS
		  n=new CustomNSView(0,0,me.Width,me.Height)
		  n.list = list
		  
		  dim types() as string
		  
		  types.Append NSPasteboardMBS.NSFilenamesPboardType
		  'types.Append NSPasteboardMBS.NSURLPboardType
		  'types.Append "public.data"
		  
		  n.registerForDraggedTypes(types)
