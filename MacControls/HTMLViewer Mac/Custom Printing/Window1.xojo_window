	...
	#tag Event
		Sub Action()
		  ...
		  if g<>nil then
		    ...
		    w=page.PageWidth-40
		    h=page.PageHeight-40
		    x=page.PageLeft+20
		    y=page.PageTop+20
		    
		    
		    c=HTMLViewer1.PrintingStartMBS(w,h)
...
#tag Events PushButton3
	#tag Event
		Sub Action()
		  call HTMLViewer1.PageSetupDialogMBS
		End Sub
	#tag EndEvent
#tag EndEvents
#tag Events PushButton4
	#tag Event
		Sub Action()
		  call HTMLViewer1.PrintDialogMBS
		End Sub
	#tag EndEvent
#tag EndEvents
...
#tag Events PushButton6
	#tag Event
		Sub Action()
		  HTMLViewer1.mainFrameMBS.frameView.documentView.print
