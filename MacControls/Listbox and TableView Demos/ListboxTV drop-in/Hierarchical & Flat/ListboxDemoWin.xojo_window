...
#tag WindowCode
	...
	#tag Constant, Name = StaticListCount, Type = Double, Dynamic = False, Default = \"16", Scope = Public
	#tag EndConstant
...
#tag Events cocoaListbox
	...
	#tag EndEvent
	#tag Event
		Function WillDisplayCell(row as Integer, column as Integer, cell as ListCellTV, textFieldCell as NSCellMBS, tableColumn as NSTableColumnMBS) As Boolean
