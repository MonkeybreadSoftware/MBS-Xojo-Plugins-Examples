...
Begin Window MainWindow
   ...
   Begin TextField InputField
      ...
      Width           =   468
   End
   Begin PushButton AddLinkButton
      AutoDeactivate  =   True
      Bold            =   False
      ButtonStyle     =   0
      Cancel          =   False
   ...
   Begin Label Label1
      ...
      TabPanelIndex   =   0
      TabStop         =   True
      Text            =   "Type some text, select some text and enter an URL to apply to selection."
      TextAlign       =   0
      TextColor       =   
      TextFont        =   "System"
      TextSize        =   0.0
...
#tag Events TextArea1
	#tag Event
		Sub SelChange()
		  AddLinkButton.Enabled = me.SelLength > 0
